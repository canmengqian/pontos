...
public class App {
    ...
    public void test1() {
        ...
        CheckedFunction0<String> supplier = CircuitBreaker.decorateCheckedSupplier(cb1, () -> rtnMsg("hello"));
    ...
    public void test2() {
        ...
        cb1.onError(0, TimeUnit.MICROSECONDS, new Exception());
        System.out.println(cb1.getState());//获取断路器的一个状态
        cb1.onError(0, TimeUnit.MICROSECONDS, new RuntimeException());
        System.out.println(cb1.getState());//获取断路器的一个状态
    }
    ...
    public void test4(){
        ...
        Retry retry = Retry.of("r1",config);
    ...
    public static String rtnMsg(String msg) {
